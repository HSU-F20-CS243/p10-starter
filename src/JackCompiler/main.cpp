...
int main(int argc, char* argv[])
{
	...
	files_to_process.push_back("SimpleFunction.jack");
	ofstream output_file{ "SimpleFunction.xml" };
	...
	CompilerEngine engine{tokens};
	output_file << engine.compile();
